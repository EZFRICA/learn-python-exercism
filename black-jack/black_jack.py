...
def is_blackjack(card_one, card_two):
    ...
    """
    dix = ['j', 'q', 'k', '10']
    return ((card_one.lower() in dix) and (card_two.lower() == 'a')) or ((card_one.lower() == 'a') and (card_two.lower() in dix))
...
def can_double_down(card_one, card_two):
    ...
    totaux = [9, 10, 11]
    return (value_of_card(card_one) + value_of_card(card_two)) in totaux
